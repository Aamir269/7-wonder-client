        ...
        <div className="carousel slide mt-1" data-bs-ride="carousel" id="carouselExampleIndicators">
          ...
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              ...
              <div className="carousel-caption">
                <h2 className="animated bounceInRight" style={{ animationDelay: '1s' }}>Machu Picchu</h2>
                <p className="animated bounceInLeft d-none d-md-block" style={{ animationDelay: '2s' }}>Built in the 15th century during the height of the Inca Empire, Machu Picchu is a testament to the advanced engineering and architectural skills of its creators. The site is situated at an elevation of approximately 7,970 feet (2,430 meters) above sea level and consists of well-preserved stone structures, terraces, temples, and residential areas. It is surrounded by lush, verdant mountains and offers panoramic views of the Urubamba River valley below.</p>
                <h5 className="animated bounceInRight" style={{ animationDelay: '3s' }}><a href="#">Learn More</a></h5>
              </div>
            </div>
            <div className="carousel-item">
              <img alt="Slide 6" className="d-block w-100" src="/Images/chichenItza.jpg" style={{ maxHeight: '80vh' }} />
              <div className="carousel-caption">
                <h2 className="animated bounceInRight" style={{ animationDelay: '1s' }}>Chichén Itzá</h2>
                <p className="animated bounceInLeft d-none d-md-block" style={{ animationDelay: '2s' }}>One of Chichén Itzá's most iconic structures is the Temple of Kukulcan, also known as El Castillo. This step pyramid serves as a calendar and astronomical observatory, with its design reflecting Mayan cosmology. During the spring and autumn equinoxes, the sunlight creates a serpent-like shadow on the pyramid's staircase, giving the illusion of the feathered serpent god, Kukulcan, descending from the heavens.</p>
                <h5 className="animated bounceInRight" style={{ animationDelay: '3s' }}><a href="#">Learn More</a></h5>
              </div>
            </div>
            <div className="carousel-item">
              <img alt="Slide 7" className="d-block w-100" src="/Images/Petra.jpg" style={{ maxHeight: '80vh' }} />
              <div className="carousel-caption">
                <h2 className="animated bounceInRight" style={{ animationDelay: '1s' }}>Petra</h2>
                <p className="animated bounceInLeft d-none d-md-block" style={{ animationDelay: '2s' }}>The history of Petra dates back to the 4th century BC when it was the capital of the Nabataean Kingdom. The city prospered as a major trading hub, strategically located along important trade routes that connected Arabia, Egypt, and the Mediterranean. Its most iconic structure is the Treasury, or Al-Khazneh, which is a beautifully carved temple facade that served as a tomb for a Nabataean king.</p>
                <h5 className="animated bounceInRight" style={{ animationDelay: '3s' }}><a href="#">Learn More</a></h5>
              </div>
            </div>
          </div>
